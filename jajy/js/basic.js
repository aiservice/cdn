...
function tsChangge(e, t) {
    ...
    !e && isSimplified || metFileLoadFun(M.weburl + "public/plugins/s2t/jquery.s2t.js", function () {
    ...
    function (e, t) {
        ...
        function u(e, t, n, i) {
            var r, o = 1, s = 20, a = i ? function () {
                ...
                , l = a(), u = n && n[3] || (re.cssNumber[t] ? "" : "px"), c = (re.cssNumber[t] || "px" !== u && +l) && ke.exec(re.css(e, t));
            if (c && c[3] !== u) {
                u = u || c[3],
                    n = n || [],
                    c = +l || 1;
        ...
        function F(e, t, n) {
            var i, r, o = 0, s = F.prefilters.length, a = re.Deferred().always(function () {
                ...
                if (r)
                    return !1;
                for (var t = nt || P(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, o = 1 - i, s = 0, l = u.tweens.length; l > s; s++)
                    u.tweens[s].run(o);
        ...
        var ue = function (e) {
            ...
            var y, b, _, w, E, x, C, T, A, S, k, I, O, D, N, j, P, L, M, R = "sizzle" + 1 * new Date, H = e.document, F = 0, $ = 0, W = n(), q = n(), B = n(), U = function (e, t) {
                    return e === t && (k = !0),
                        0
                    ...
                    for (var n = 0, i = e.length; i > n; n++)
                        if (e[n] === t)
                            return n;
                    return -1
                }, Z = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ee = "[\\x20\\t\\r\\n\\f]", te = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", ne = "\\[" + ee + "*(" + te + ")(?:" + ee + "*([*^$|!~]?=)" + ee + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + te + "))|)" + ee + "*\\]", ie = ":(" + te + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ne + ")*)|.*)\\)|)",
                re = new RegExp(ee + "+", "g"), oe = new RegExp("^" + ee + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ee + "+$", "g"), se = new RegExp("^" + ee + "*," + ee + "*"), ae = new RegExp("^" + ee + "*([>+~]|" + ee + ")" + ee + "*"), le = new RegExp("=" + ee + "*([^\\]'\"]*?)" + ee + "*\\]", "g"), ue = new RegExp(ie), ce = new RegExp("^" + te + "$"), fe = {
                    ID: new RegExp("^#(" + te + ")"),
                    CLASS: new RegExp("^\\.(" + te + ")"),
                    TAG: new RegExp("^(" + te + "|[*])"),
                    ATTR: new RegExp("^" + ne),
            ...
            b = t.support = {},
                    ...
                    (b.matchesSelector = pe.test(L = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && r(function (e) {
                        ...
                        U = t ? function (e, t) {
                                ...
                                return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1,
                                    1 & n || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === O || e.ownerDocument === H && M(H, e) ? -1 : t === O || t.ownerDocument === H && M(H, t) ? 1 : S ? J(S, e) - J(S, t) : 0 : 4 & n ? -1 : 1)
                            }
                            : function (e, t) {
                                if (e === t)
                                    return k = !0,
                                ...
                                if (!r || !o)
                                    return e === O ? -1 : t === O ? 1 : r ? -1 : o ? 1 : S ? J(S, e) - J(S, t) : 0;
                                if (r === o)
                                    return s(e, t);
                ...
                t.matchesSelector = function (e, n) {
                    if ((e.ownerDocument || e) !== O && I(e),
                        n = n.replace(le, "='$1']"),
                    b.matchesSelector && N && !B[n + " "] && (!P || !P.test(n)) && (!j || !j.test(n)))
                        try {
                            var i = L.call(e, n);
        ...
        var Ue, Ve = {
            HTML: "block",
            BODY: "block"
        }, ze = /^margin/, Ge = new RegExp("^(" + Se + ")(?!px)[a-z%]+$", "i"), Qe = function (t) {
            ...
            style: function (e, t, n, i) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    ...
                    return t = re.cssProps[a] || (re.cssProps[a] = k(a) || a),
                        ...
                        "string" === o && (r = ke.exec(n)) && r[1] && (n = u(e, t, r),
                            o = "number"),
            ...
            re.each(["height", "width"], function (e, t) {
                re.cssHooks[t] = {
                    ...
                    set: function (e, n, i) {
                        ...
                        return s && (r = ke.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n,
                            n = re.css(e, t)),
                            I(e, n, s)
                    }
                }
        ...
        re.ajaxSetup({
            ...
            re.ajaxPrefilter("json jsonp", function (t, n, i) {
                ...
                return a || "jsonp" === t.dataTypes[0] ? (r = t.jsonpCallback = re.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
                    a ? t[a] = t[a].replace(Lt, "$1" + r) : !1 !== t.jsonp && (t.url += (vt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r),
                    ...
                    value: function () {
                        ...
                        if (this.enabled) {
                            ...
                            var x = {
                                ...
                                , A = T.defaultView
                                , S = void 0;
                            return A.innerHeight > T.documentElement.clientHeight && (S = this.cache("scrollbar-size", u),
                                x.viewport.bottom -= S.height),
                            A.innerWidth > T.documentElement.clientWidth && (S = this.cache("scrollbar-size", u),
                                x.viewport.right -= S.width),
...
+function (e) {
    ...
    window.Modernizr = function (e, t, n) {
        ...
        }, T = {}, A = {}, S = {}, k = [], I = k.slice, O = function (e, n, i, r) {
...
M.iebrowser_ver < 10 && (M.is_lteie9 = !0)),
    window.met_lazyloadbg = $("input[name=met_lazyloadbg]").val() || M.weburl + "slick/loading.gif",
...
"undefined" != typeof Breakpoints && Breakpoints(),
            ...
            if (includeFileIndex >= t && includeFileIndex < n) {
                ...
                if ("js" == a[0]) {
                    ...
                    includeFileIndex > file_index)
                        ...
                        if (!($('script[src="' + u + '"]').length && includeFileIndex == file_index || !$('script[src="' + u + '"]').length && void 0 !== c))
    ...
    $(function () {
        ...
        e && $.ajax({
            ...
            success: function (e) {
                !parseInt(e.status) && (document.write(""),
                    setTimeout(function () {
                        alert(e.msg),
        ...
        var r = $("[data-original]");
        r.length && metFileLoadFun(M.weburl + "public/plugins/jquery.lazyload.min.js", function () {
        ...
        s.length && $.include(M.weburl + "public/plugins/select-linkage/jquery.cityselect.js", function () {
            s.each(function (e, t) {
                $(this).citySelect({
        ...
        videoSizeRes: function () {
            $(this).each(function () {
                var e = $(this)
                    ...
                    , n = $(this).width();
                ("IFRAME" == $(this).prop("tagName") ? !$(this).attr("width") : $(this).attr("width") && n < 10) && (t = parseInt(this.style.height) ? parseInt(this.style.height) / parseInt(this.style.width) : .5625,
                    n = $(this).attr("width") || parseInt(this.style.width) || 480,
                    $(this).width(n),
                    n = $(this).width()),
