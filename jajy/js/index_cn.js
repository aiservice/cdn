...
METUI_FUN['head_nav_met_11_1_38'] = {
name: 'head_nav_met_11_1_38',
init: function() {
var aLink = METUI['head_nav_met_11_1_38'].find('.dropdown a.nav-link');
...
shadow: function() {
var fixed = METUI['head_nav_met_11_1_38'].parent();
if (fixed) {
...
animate: function() {
var li = METUI['head_nav_met_11_1_38'].find('.nav-item');
...
dropdown: function() {
var dropdownSubmenu = METUI['head_nav_met_11_1_38'].find('.navlist .dropdown-submenu');
...
cntotc: function() {
var b = $('.head_nav_met_11_1_38 .btn-cntotc');
...
navmore: function() {
$met_navlist = METUI['head_nav_met_11_1_38'].find('.navlist');
...
var x = new metui(METUI_FUN['head_nav_met_11_1_38']);
METUI_FUN['banner_met_11_1_33'] = {
name: 'banner_met_11_1_33',
init: function() {
var $metbanner=METUI['banner_met_11_1_33'],
metbanner_slide='.banner_met_11_1_33 .slick-slide';
if($metbanner.length){
var img = METUI['banner_met_11_1_33'].find('.cover-image').eq(0);
...
var slide = METUI['banner_met_11_1_33'].find('.slick-slide'),
...
enter: function() {
METUI['banner_met_11_1_33'].find('.cover-image').height(bh[0]);
}
})
Breakpoints.on('sm', {
enter: function() {
METUI['banner_met_11_1_33'].find('.cover-image').height(bh[1]);
}
})
Breakpoints.on('xs', {
enter: function() {
METUI['banner_met_11_1_33'].find('.cover-image').height(bh[2]);
}
})
...
if (slide.length > 1) {
METUI['banner_met_11_1_33'].slick({
autoplay: true,
...
METUI['banner_met_11_1_33'].find('.cover-image').css('display', 'block');
$('.banner_met_11_1_33 .slick-slide .banner-text').hide();
$('.banner_met_11_1_33 .slick-slide.slick-active .banner-text').show();
});
}
})
}
...
var banner = metui(METUI_FUN['banner_met_11_1_33']);
METUI_FUN['subcolumn_nav_met_16_1_44'] = {
name:'subcolumn_nav_met_16_1_44',
init:function (){
if(device_type!='d') $('body').wrapInner('<div class="cover"></div>');
var $metcolumn_nav=METUI['subcolumn_nav_met_16_1_44'].find('ul');
...
var x = new metui(METUI_FUN['subcolumn_nav_met_16_1_44']);
METUI_FUN['foot_nav_met_16_1_35'] = {
name:'foot_nav_met_16_1_35',
weixin:function (){
...
mnav:function(){
var navl=METUI['foot_nav_met_16_1_35'].find('.mob-masonry .masonry-item'),
mob_masonry=METUI['foot_nav_met_16_1_35'].find('.mob-masonry');
if(navl.length){
...
var x = new metui(METUI_FUN['foot_nav_met_16_1_35']);
METUI_FUN['foot_info_met_16_1_36'] = {
name:'foot_info_met_16_1_36',
cntotc:function(){
var b=METUI['foot_info_met_16_1_36'].find('.btn-cntotc');
b.on('click', function(event) {
var lang=$(this).attr('data-tolang');
if (lang=='tc') {
$('body').s2t();
...
bg: function() {
$('.foot_info_met_16_1_36_bottom[data-bg]').each(function(index, el) {
...
ifbotc = $('.foot_info_met_16_1_36_bottom').data('ifbotc');
if(ifbotc){
...
padding:function(){
if(METUI['foot_info_met_16_1_36'].length){
var h_m=$('.foot_info_met_16_1_36_bottom').height();
$(window).resize(function(){
pd();
})
function pd(){
if($('.foot_info_met_16_1_36_bottom').hasClass('iskeshi') || $(window).width()<768){
METUI['foot_info_met_16_1_36'].css("padding-bottom",h_m);
...
qq:function(){
$(".foot_info_met_16_1_36_bottom .item").each(function(){
...
var x = new metui(METUI_FUN['foot_info_met_16_1_36']);
METUI_FUN['back_top_met_16_1_47'] = {
name:'back_top_met_16_1_47',
totop: function() {
...
var banner=metui(METUI_FUN['back_top_met_16_1_47']);
METUI_FUN['service_list_met_11_1_39'] = {
name: 'service_list_met_11_1_39',
init: function() {
var list = METUI['service_list_met_11_1_39'].find('.service-list');
if (list.length) {
...
appear: function() {
if (METUI['service_list_met_11_1_39'].length) {
var repeat = false;
function animation() {
if (repeat == false) {
var title = METUI['service_list_met_11_1_39'].find('.title'),
subtitle = METUI['service_list_met_11_1_39'].find('.subtitle'),
desc = METUI['service_list_met_11_1_39'].find('.desc'),
...
var item = METUI['service_list_met_11_1_39'].find('.item');
...
triggerElement: '.service_list_met_11_1_39',
offset: -300
}).addTo(controller);
...
var x = new metui(METUI_FUN['service_list_met_11_1_39']);
METUI_FUN['product_list_met_16_1_4'] = {
name:'product_list_met_16_1_4',
appear:function (){
...
navtab:function(){
var $met_indexpro_navtabs=METUI['product_list_met_16_1_4'].find(".nav-tabs");
var list=METUI['product_list_met_16_1_4'].find('.index-product-list');
...
var x = new metui(METUI_FUN['product_list_met_16_1_4']);
METUI_FUN['about_list_met_16_2_42'] = {
name:'about_list_met_16_2_42',
appear:function (){
var indexappear=$('.met-index-body:eq(0) [data-plugin=appear]');
if(indexappear.length){
indexappear.scrollFun(function(val){
...
var x = new metui(METUI_FUN['about_list_met_16_2_42']);
METUI_FUN['news_list_met_16_2_41'] = {
name:'news_list_met_16_2_41',
appear:function (){
var indexappear=$('.met-index-body:eq(0) [data-plugin=appear]');
if(indexappear.length){
indexappear.scrollFun(function(val){
...
var x = new metui(METUI_FUN['news_list_met_16_2_41']);